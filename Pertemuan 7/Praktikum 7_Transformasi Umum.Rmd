...
Persamaan eksponensial: $Y = αe^βx$
...
Implikasi dari transformasi kedua ruas, maka $β0=ln(a)$ dan $β1=b$
...
Mengecek apakah nilai a hasil transformasi balik sudah sesuai dengan nilai a yang asli. Karena $β0=ln(a)$, maka $a=eβ0$.
